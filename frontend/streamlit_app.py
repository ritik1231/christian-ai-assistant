...
def _show_image(url: str) -> None:
    """Show image as an open-in-browser button (CSP on Streamlit Cloud blocks direct embed)."""
    st.link_button("🖼 View Generated Image", url, use_container_width=True)
    st.caption("Opens in a new tab — generated by Pollinations.ai (takes ~20 seconds on first load)")
